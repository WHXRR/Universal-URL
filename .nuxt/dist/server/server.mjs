...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b703e693.js").then((m) => m.default || m)
  },
  {
    name: "provide",
    path: "/provide",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-4e993758.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-d4a55c19.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-c887a09e.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-f1302f0a.js").then((r) => r.default || r));
